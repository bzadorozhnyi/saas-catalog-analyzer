...
SEED_ITEMS: list[tuple[str, str, SoftwareCategoryEnum]] = [
    (
        "Slack",
        "Team messaging and chat app for workplace communication",
        SoftwareCategoryEnum.COMMUNICATION,
    ),
    (
        "Microsoft Teams",
    ...
    (
        ...
        SoftwareCategoryEnum.PROJECT_MANAGEMENT,
    ),
    (
        "Linear",
    ...
    (
        ...
        SoftwareCategoryEnum.ACCOUNTING,
    ),
    (
        "Xero",
    ...
    (
        ...
        SoftwareCategoryEnum.DEVELOPER_TOOLS,
    ),
    (
        "GitLab",
